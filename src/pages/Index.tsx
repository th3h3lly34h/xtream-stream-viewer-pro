...
const Index = () => {
  ...
  const getStreamUrl = useCallback(() => {
    ...
    // Force using HTTP protocol
    let streamBaseUrl = credentials.url;
    if (streamBaseUrl.startsWith('https://')) {
      console.log('Adjusting URL from HTTPS to HTTP');
      streamBaseUrl = streamBaseUrl.replace('https://', 'http://');
    }
